...
<head>
  ...
  <title>Case Studies — Creatix SEO Agency</title>
  ...
  <style>
    ...
    * { font-family: 'Manrope', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .case-card:hover { transform: translateY(-6px); box-shadow: 0 20px 40px rgba(0,0,0,0.4); }
    .result-stat {
    ...
    .result-stat .number { font-size: 1.8rem; font-weight: 800; color: #A6F13B; }
    ...
    .filter-btn { background: #141414; border: 1px solid rgba(255,255,255,0.08); border-radius: 9999px; padding: 0.5rem 1.2rem; font-size: 0.8rem; transition: all 0.3s; cursor: pointer; color: #b0b0b0; }
    .filter-btn:hover, .filter-btn.active { background: #A6F13B; color: #101010; border-color: #A6F13B; }
  </style>
</head>
<body>
