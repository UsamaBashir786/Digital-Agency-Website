...
<head>
  ...
  <title>Web Development Services — Creatix Agency</title>
  ...
  <style>
    ...
    * { font-family: 'Manrope', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .tech-stack { background: #141414; border: 1px solid rgba(255,255,255,0.06); border-radius: 0.75rem; padding: 0.5rem 1rem; font-size: 0.75rem; color: #b0b0b0; transition: all 0.3s; }
    .tech-stack:hover { border-color: rgba(166, 241, 59, 0.3); color: #A6F13B; }
  </style>
</head>
<body>
